...
if ((byInputBuffer[0] == '\xf0') && ((byInputBuffer[7] == '\x40') || (byInputBuffer[7] == '\x80') || (byInputBuffer[7]  == '\xC0'))  ) //Т.е. это ответ на известную команду  && (byInputBuffer[7] == '\x40')
    {  // && ((byInputBuffer[7] == '\x40') || (byInputBuffer[7] == '\x80'))
