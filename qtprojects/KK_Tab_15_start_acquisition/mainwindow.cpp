...
//++++++++++++++++++++++++++++++
 ...
 //   target_name = QCoreApplication::applicationFilePath();
   ...
   // ui->Frequency_frame->setStyleSheet("border-color: rgb(0, 0, 0);");
    ...
    ui->N_Spectral_Channel_spinBox_Single->setVisible(false); // Прячем QSpinBox "N_Spectral_Channel_spinBox_Single"
    ui->label_21->setVisible(false);
  // N_Spectral_Channel_spinBox_Single
...
//ui->tab_camac->
/*
gauge_Tansfer = new camac_paint(ui->tab_camac);
gauge_Tansfer->resize(30,30);
gauge_Tansfer->setGeometry(1050, 10, 30, 30);
...
*/
 ...
 /*         Z_flag = new camac_paint(ui->tabWidget);

         // Z_flag->setParent(ui->gauge_Tansfer);
           Z_flag->setWindowOpacity(1);


          Z_flag->resize(30,30);
          Z_flag->setGeometry(150,270,30,30);

          Z_flag->setAutoFillBackground(false);

          Z_flag->setStyleSheet(conn_marker_color_blue);
          Z_flag->raise();
          Z_flag->repaint();
          Z_flag->show();
          update();
...
if (value == FTDI_OK) {
    //gauge_Tansfer->KK_connected = TRUE;
    FTDI_Connected = TRUE;

   ui->gauge_Tansfer->setStyleSheet(conn_marker_color_blue); //green
   transfer_flashing = true;
...
void MainWindow::Update_Label(void)
{
   ...
   // 20.05.2019 Убираем, в продакшн не будет
...
void MainWindow::on_Clear_All_clicked()
{
    ...
    ui->gauge_Tansfer->setStyleSheet(conn_marker_color_green);
 //   ui->Q_flag->setStyleSheet(conn_marker_color_red);
 //   ui->X_flag->setStyleSheet(conn_marker_color_red);
//    gauge_Tansfer->palette.setColor(QPalette::Light, Qt::blue);
//    gauge_Tansfer->setPalette(gauge_Tansfer->palette);
    ...
    // ui->NAF_Data_Label->setText(str);// Убираем в продакшн версии
...
void MainWindow::on_Sel_Bit_16_toggled(bool checked)
{
    ...
    {  ui->Sel_Bit_16->setStyleSheet(conn_marker_color_dark_green);
...
void MainWindow::on_Sel_Bit_15_toggled(bool checked)
{
    ...
    {  ui->Sel_Bit_15->setStyleSheet(conn_marker_color_dark_green);
...
void MainWindow::on_Sel_Bit_14_toggled(bool checked)
{
    ...
    {  ui->Sel_Bit_14->setStyleSheet(conn_marker_color_dark_green);
...
void MainWindow::on_Sel_Bit_13_toggled(bool checked)
{
    ...
    {  ui->Sel_Bit_13->setStyleSheet(conn_marker_color_dark_green);
...
void MainWindow::on_Sel_Bit_12_toggled(bool checked)
{
    ...
    {  ui->Sel_Bit_12->setStyleSheet(conn_marker_color_dark_green);
...
void MainWindow::on_Sel_Bit_11_toggled(bool checked)
{
    ...
    {  ui->Sel_Bit_11->setStyleSheet(conn_marker_color_dark_green);
...
void MainWindow::on_Sel_Bit_10_toggled(bool checked)
{
    ...
    {  ui->Sel_Bit_10->setStyleSheet(conn_marker_color_dark_green);
...
void MainWindow::on_Sel_Bit_09_toggled(bool checked)
{
    ...
    {  ui->Sel_Bit_09->setStyleSheet(conn_marker_color_dark_green);
...
void MainWindow::on_Sel_Bit_08_toggled(bool checked)
{
    ...
    {  ui->Sel_Bit_08->setStyleSheet(conn_marker_color_dark_green);
...
void MainWindow::on_Sel_Bit_07_toggled(bool checked)
{
    ...
    {  ui->Sel_Bit_07->setStyleSheet(conn_marker_color_dark_green);
...
void MainWindow::on_Sel_Bit_06_toggled(bool checked)
{
    ...
    {  ui->Sel_Bit_06->setStyleSheet(conn_marker_color_dark_green);
...
void MainWindow::on_Sel_Bit_05_toggled(bool checked)
{
    ...
    {  ui->Sel_Bit_05->setStyleSheet(conn_marker_color_dark_green);
...
void MainWindow::on_Sel_Bit_04_toggled(bool checked)
{
    ...
    {  ui->Sel_Bit_04->setStyleSheet(conn_marker_color_dark_green);
...
void MainWindow::on_Sel_Bit_03_toggled(bool checked)
{
    ...
    {  ui->Sel_Bit_03->setStyleSheet(conn_marker_color_dark_green);
...
void MainWindow::on_Sel_Bit_02_toggled(bool checked)
{
    ...
    {  ui->Sel_Bit_02->setStyleSheet(conn_marker_color_dark_green); //conn_marker_color_dark_green
...
void MainWindow::on_Sel_Bit_01_toggled(bool checked)
{
    ...
    {  ui->Sel_Bit_01->setStyleSheet(conn_marker_color_dark_green);
...
{
   // Проверить подключено ли FTDI-устройство
   if (!FTDI_Connected) return;
...
void MainWindow::on_pushButton_stop_Sending_clicked()
{
    ...
    ui->gauge_Tansfer->setStyleSheet(conn_marker_color_blue); //blue
...
void MainWindow::on_Stop_ALL_pushButton_clicked()
{
  ...
  {
   if (timer_flash->isActive()) {timer_flash->stop();}
 //   gauge_Tansfer->KK_connected = FALSE;
...
{
  //if (!gauge_Tansfer->KK_connected) ftdi_answer_parser(KAN->ftdi_init());
;
}
//+++++++++++++++++++++++++++
void MainWindow::On_Transfer_Flashing()
{
  ...
  //  gauge_Tansfer->transfer_flashing = !gauge_Tansfer->transfer_flashing;
    transfer_flashing = !transfer_flashing;

   // if (gauge_Tansfer->transfer_flashing)
      if (transfer_flashing)
    {
        ui->gauge_Tansfer->setStyleSheet(conn_marker_color_red); //green
    }
else
    {

        ui->gauge_Tansfer->setStyleSheet(conn_marker_color_black);  //gray
    }
}
//++++++++++++++++++++++++++
...
//ui->gauge_Tansfer->setStyleSheet(conn_marker_color_dark_green); //green
// gauge_Tansfer->setPalette(gauge_Tansfer->palette);

ui->X_flag->setStyleSheet(conn_marker_color_red);  //red
...
//    update();
 ...
 str.sprintf("Camac Station %u is not connected, there is no X-signal", N_num);
 KAN->KK_Write_To_Log(0x1111, str);

ui->gauge_Tansfer->setStyleSheet(conn_marker_color_black);  // black X_flag->update();
}
//+++++++++
void MainWindow::Camac_N_Q_Flag_Slot()
{
    ui->Q_flag->setStyleSheet(conn_marker_color_red);  //red
   // Q_flag->update();
}

void MainWindow::Camac_N_Q_NOT_Flag_Slot()
{
        ui->Q_flag->setStyleSheet(conn_marker_color_black);  // black
    //    Q_flag->update();
}
...
void MainWindow::on_Start_Aquisition_pushButton_clicked()
{
    ...
    if (!FTDI_Connected) {Write_To_Log(0x2222, "НЕТ СВЯЗИ !!! \n"); return;}
    else
   {
    // Проверить, открыт ли файл набора и если нет, то открыть.
...
// ============================================   Блок ответов ф-ции ftdi_init()    =================================================================
 ...
 //       break;
    ...
    case 0x0002:
                ...
                FTDI_Connected = FALSE; // Установили флаг
                break;
    case 0x0003:
    ...
    case 0x0AAA:  Write_To_Log(value, "ftdi_init()->Устройство распознано!\n");
                 FTDI_Connected = TRUE; // Установили флаг
                 break;
 ...
 //   BOOL ALL_COMMANDS_CORRECT = false;
  ...
  //  QTextStream uin;
   ...
   // str1="Зашли в Command_File_Execute\n";Write_To_Log(0XAAAA, str1);
    ...
    if (!FTDI_Connected) //(!gauge_Tansfer->KK_connected)
    {//   "Устройство не подключено !!! Команды не выполнены\n";
        return 0x02ff;
    }
...
void MainWindow::on_Show_Spectral_Selected_From_File_Single_pushButton_clicked()
{
    ;
}

void MainWindow::on_Sel_Bit_02_clicked()
{
